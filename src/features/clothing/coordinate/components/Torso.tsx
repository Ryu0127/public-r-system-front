  ...
  return (
    <div className="relative bg-gradient-to-b from-gray-50 to-gray-100 rounded-2xl p-8 shadow-xl">
      <div className="relative w-full max-w-md mx-auto">
        {/* ファッションデザイン画風のトルソー背景 */}
        <div className="relative mb-6 flex justify-center items-start" style={{ minHeight: '500px' }}>
          {/* トルソー画像 */}
          ...
          {/* アイテム配置エリア - トルソーの上に重ねる */}
          <div className="relative z-10 space-y-4 w-full" style={{ minHeight: '600px' }}>
            {/* アウター */}
            <div
