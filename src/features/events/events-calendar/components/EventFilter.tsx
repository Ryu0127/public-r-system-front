 ...
 */
const EventFilter: React.FC<EventFilterProps> = ({ selectedFilters, onToggleFilter, onClearAllFilters, onSelectAllFilters }) => {
  ...
  return (
    <div className="flex items-center gap-4 flex-wrap">
      ...
      <button
        ...
        className="px-3 py-1 text-sm font-medium text-amber-600 bg-white border border-amber-300 rounded-md hover:bg-amber-50 hover:text-amber-700 hover:border-amber-400 transition-colors"
      >
        すべてチェック
      </button>
      <button
