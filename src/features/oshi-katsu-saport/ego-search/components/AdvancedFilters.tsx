    ...
    <div className="max-w-2xl mx-auto mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 shadow-lg">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-xs text-gray-600">最小いいね数</label>
              <input
                type="number"
                value={filters.minLikes ?? ''}
                onChange={(e) => actions.setMinLikes(e.target.value ? parseInt(e.target.value) : null)}
                placeholder="0"
                min="0"
            ...
            <div>
              <label className="text-xs text-gray-600">最小リツイート数</label>
              <input
                type="number"
                value={filters.minRetweets ?? ''}
                onChange={(e) => actions.setMinRetweets(e.target.value ? parseInt(e.target.value) : null)}
                placeholder="0"
                min="0"
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
        ...
        <div className="mb-4">
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2">
              ...
              />
              <span className="text-sm text-gray-700">リプライを除外</span>
            </label>
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
                ...
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="text-sm text-gray-700">リツイートを除外</span>
            </label>
          </div>
        </div>
